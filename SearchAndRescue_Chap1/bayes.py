...
def main():
    print('Welcome to search and rescue')
    ...
    while True:
        ...
        if choice == "0":
            ...
            main() # is it smart to call main recursively like this?
        else:
...
class Search:
    ...
    def draw_map(self, last_known):
        ...
        cv.rectangle(self.img, (SA2_CORNERS[0], SA2_CORNERS[1]), (SA2_CORNERS[2], SA2_CORNERS[3]),
                     (0,0,0), 1)
        cv.putText(self.img, '2', (SA2_CORNERS[0] + 3, SA2_CORNERS[1] + 15), cv.FONT_HERSHEY_PLAIN, 1, 0)
        cv.rectangle(self.img, (SA3_CORNERS[0], SA3_CORNERS[1]), (SA3_CORNERS[2], SA3_CORNERS[3]),
                     (0, 0, 0), 1)
